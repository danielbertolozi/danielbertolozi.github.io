...
Antes de qualquer outra coisa, utilize pneus bons e faça uma geometria adequada ao seu uso! 

### Se o seu carro é de rua, pare por aqui

Para a maioria dos usos os itens listados acima serão suficientes. Os itens abaixo são indicados em caso de: 
- Oportunidade (meu caso), se o conjunto inteiro aparecer a venda por um valor realmente bom
- Uso em pista: mas mesmo assim, corra pelo menos um evento, para ter certeza que você precisa mesmo desses upgrades 
- Desgaste de componentes originais, onde o upgrade valha a pena pela pouca diferença de custo. Lembre-se de considerar valores de mão de obra caso você não esteja fazendo por si mesmo. 
